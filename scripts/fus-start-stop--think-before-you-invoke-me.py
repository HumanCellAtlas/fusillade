...
if "start" == args.action:
    msg = f"(Fusillade {stage} START) Lambdas will be restarted with default concurrency limits. Continue?"
elif "stop" == args.action:
    msg = f"(Fusillade {stage} STOP) Lambdas will be halted by setting concurrency=0. Continue?"
else:
